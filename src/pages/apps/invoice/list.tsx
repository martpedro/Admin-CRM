      ...
      },
      {
        ...
        cell: (cell) => {
          switch (cell.getValue()) {
            case 'Cancelled':
              return <Chip color="error" label="Cancelada" size="small" variant="light" />;
            case 'Paid':
              return <Chip color="success" label="Pagada" size="small" variant="light" />;
            case 'Unpaid':
            default:
              return <Chip color="info" label="No pagada" size="small" variant="light" />;
          }
        },
            ...
            <Stack direction="row" sx={{ alignItems: 'center', justifyContent: 'center' }}>
              <Tooltip title="Ver">
                <IconButton
                  ...
                  onClick={(e: any) => {
                    e.stopPropagation();
                    navigation(`/sales/details/${row?.original?.id}`);
                  }}
                >
                  <Eye />
                </IconButton>
              ...
              <Tooltip title="Editar">
                <IconButton
                  ...
                  onClick={(e: any) => {
                    e.stopPropagation();
                    navigation(`/sales/edit/${row?.original?.id}`);
                  }}
                >
                  <Edit />
                </IconButton>
